...
This script will compare three activation modes with model distillation:
  ...
  3) multistage: Transition convex (use only 1st epoch)→nonconvex(i.e., rest of epochs) after switch_epoch + nonconvex  cytokines- antigentic Landscape with model distillation (To overcome local optima in  the antigentic Landscape Modeling)
